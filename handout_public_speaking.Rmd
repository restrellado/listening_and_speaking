---
title: "Getting (Slightly) More Comfortable With Public Speaking"
author: "Ryan Estrellado"
date: "2/9/2018"
output: html_document
---

In [her TED talk](https://www.ted.com/talks/kelly_mcgonigal_how_to_make_stress_your_friend), Kelly McGonigal encourages the audience to view stress as our body's mechanism for preparing for a challenge. In the context of this handout, this useful for two reasons: 

First, it normalizes the experience of stress. Though different people feel different levels of stress around public speaking, stress is very much a natural thing and should be expected. 

Second, when we feel stress around public speaking and we think "this feeling is useful for preparing me to rise to the challenge of doing this talk", we're more likely to welcome a reasonable amount of stress. We can even benefit from the increased focus and concentration that stress tends to bring. 


# Fear Reduction, Not Fear Elimination  

I generally find that it's not useful to take on the goal of having zero fear before a talk. That's a mostly unattainable goal for me. I have observed over fifteen years of public speaking though that I've been *more* scared before some talks than others. So a more useful question is, what are the behaviors you can demonstrate in the days leading up to your talk that *reduce* fear. Here are the behaviors that I found reduce my fear and anxiety: 
...
I find it useful to try and find projects that give me just the right balance of skill and balance. In Mihaly Csikszentmihalyi's book Flow, he demonstrates this idea through a mental model that compares difficulty of a task against a person's skill level
...
So if you are feeling overwhelmed by the idea of public speaking, it may be helpful to ask yourself some questions to help uncover what a good next step is for you. Here are some examples, but do some reflecting and come up with ones that are useful for you. 
